...
eat_sound = pygame.mixer.Sound('assets/sounds/pacman_eatfruit.wav')
ghost_eaten_sound = pygame.mixer.Sound('assets/sounds/pacman_eatghost.wav')
game_over_sound = pygame.mixer.Sound('assets/sounds/pacman_dies_y.wav')
win_sound = pygame.mixer.Sound('assets/sounds/pacman_intro.wav')
player_x = 450
player_y = 663
direction = 0
blinky_x = 56
...
# Generate children (neighbors)
    ...
    for new0_position in neighbors:
